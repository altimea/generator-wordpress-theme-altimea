...
class CustomFields
{
	...
	*/
	...
	public function create_meta_box()
	{
		if ( function_exists('add_meta_box') ) {
			// create metaboxs
			add_meta_box(
				'new_meta_boxes_page',				// Unique ID
				'Lotus'  . ' Page Settings',		// Box title
				array($this, 'new_meta_boxes_page'),// Content callback, must be of type callable
				'page',								// Post type
				'normal',
				'high'
			);
	...
	/*
			add_meta_box(
				'new_meta_boxes_portfolio',
				'Lotus'  . ' Portfolio Settings',
				array($this, 'new_meta_boxes_portfolio'),
				'portfolio',
				'normal',
				'high'
			);
	*/
	...
	public function new_meta_boxes_portfolio() {
		$this->new_meta_boxes('Portfolio');
	}

	private function setDefaultMetaBox()
	{
		$newsData = array(
			// Portfolio
		...
		$this->metaBoxOption = array_merge( $this->metaBoxOption, $newsData );
	}

	/**
	 * Add more custom fields for post, page, & and other customPostType
	 */
	public function add(array $metaBoxOption = array())
	{

		$this->metaBoxOption = array_merge( $this->metaBoxOption, $metaBoxOption );
	}
	...
	public function new_meta_boxes( $type ) {
		global $post;
		$new_meta_boxes = $this->metaBoxOption;
